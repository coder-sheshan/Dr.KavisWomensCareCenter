...
const Testimonial = () => {
  ...
  return (
    <div data-aos="zoom-in">
      <h1 className="text-xl flex justify-center font-normal">
      ...
      <div className=" h-[250px] py-5 px-5 mb-5">
        <div className=" h-[250px] mx-2">
          ...
          >
            <SwiperSlide>
              <article className="rounded-lg border w-full border-gray-100 bg-pink-100 p-4 shadow-sm transition hover:shadow-lg sm:p-6">
                <a href="#">
                  <h3 className="mt-0.5 text-lg font-medium text-pink-500">
                    Manoesruthyyy Yokesh Raj
                  </h3>
                </a>

                <p className="mt-2 line-clamp-3 text-sm/relaxed text-gray-500">
                  "It's an amazing experience for me to take treatment here.I
                  have never been to hospital for any other treatment or for any
                  other reasons, but here when they were about to start the
                  treatment I was nervous and frightened.But when I met Dr
                  Kavitha Nagarajan mam, she interacted with us humbly and
                  explained about the treatment clearly. After that I felt more
                  comfortable. Even the staffs working there were nice and they
                  made me to get rid of my fear."
                </p>
