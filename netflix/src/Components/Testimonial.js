...
const Testimonial = () => {
  return (
    <div>
      ...
      <div className="m-10 mx-auto p-5 sm:p-10 lg:p-5 bg-white">
        <div
        ...
        >
          ...
          <div className="w-full md:w-3/5 h-full flex items-center bg-gray-100 rounded-lg">
            <div className="p-12 md:pr-24 md:pl-16 md:py-12">
              ...
              <a
                className="flex items-baseline mt-3 text-pink-600 hover:text-indigo-900 focus:text-indigo-900"
                href="/testimonial"
              >
